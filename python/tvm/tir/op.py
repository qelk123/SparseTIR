...
def atomic_add(ptr, elem_offset, val, span=None):
    ...
    elem_offset : PrimExpr
        The offset of the element in the buffer we perform atomic add.
    val : PrimExpr
        The value to add.
    span : Optional[Span]
    ...
    """
    return _ffi_api.atomic_add(ptr, elem_offset, val, span)  # type: ignore
